...
public class Initializer {
	...
	public static void main(String[] args) throws SQLException, ParseException{
		...
		String q = "CREATE TABLE tbl_Customer("
				...
				+ "age  NUMBER,"
				+ "adr1 VARCHAR2(45 char),"
				+ "adr2 VARCHAR2(45 char),"
				+ "city VARCHAR2(45 char),"
				+ "state VARCHAR2(20 char),"
				+ "status VARCHAR2(45 char),"
				+ "msg VARCHAR2(45 char),"
		...
		q = "CREATE TABLE tbl_LoginTeller("
				+ "username NUMBER PRIMARY KEY,"
				+ "password VARCHAR2(45 CHAR))";
		...
		x = dbController.createExecutiveLogin(123456789, "admin", con);
		System.out.println(x);
		
		x = dbController.createTellerLogin(987654321, "admin", con);
		System.out.println(x);
